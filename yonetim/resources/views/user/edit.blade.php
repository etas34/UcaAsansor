                            ...
                            <form action="{{route('user.update',$user->id)}}" method="post" autocomplete="off">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text"  name="password" class="form-control" placeholder="En Az 6 Karakter" >
                                    </div>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                @foreach($yetki as $key=>$value)
                                                    <div class="custom-control custom-checkbox">
                                                        <input class="custom-control-input" type="checkbox" @if(in_array($value->id,explode(",",$user->yetki))) checked @endif id="customCheckbox{{$key}}" name="yetki[]" value="{{$value->id}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-check col-md-3">
                                            <input {{ $user->renk == $color ? 'checked' : ''}} class="form-check-input" type="radio" name="renk" value="{{$color}}" id="{{$color}}">
