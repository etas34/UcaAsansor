                                ...
                                <div class="row justify-content-end">
                                    ...
                                    <div class="col-4 text-right" style="line-height:10px !important;">
                                        ...
                                        <div class="form-group-sm">
                                            ...
                                            <input type="date" id="datePicker" class="text-right" name="rapor_tarihi" value="{{$teklif->rapor_tarihi}}">
                                            <!-- /.input group -->
                                        </div>
                                    </div>
                                    <!-- /.col -->
                                    ...
                                    <div class="col-12 table-responsive">
                                        <table class="table table-striped" id="myTable">
                                            ...
                                            @foreach($urun as $key=>$value)
                                                <tr>
                                                    <td style="padding: 0px !important;"><input type="text" class="form-control" name="urun[{{$key}}][aciklama]" value="{{$value->aciklama}}"></td>
